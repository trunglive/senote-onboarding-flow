      ...
      <div>
        ...
        <div class="border-t border-dashed">
          <div class="flex flex-col mt-4">
            <a @click="handleClickContinue" href="#" :class="showSpinner ? 'bg-white-light' : 'bg-ocean'" class="w-80 h-12 flex flex-col items-center justify-center rounded-md text-white font-bold duration-200 hover:bg-ocean-dark ease-in-out">
